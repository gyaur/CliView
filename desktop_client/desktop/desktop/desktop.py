...
logo_label = tk.Label(logo_frame,  bg="#87CEFA", image=logo).pack(anchor="center")
...
sound_label = ttk.Label(sound_frame, image=sound_icon).grid(row=0, column=0)
...
main_window.mainloop()                  #This is the main event loop place your code before this
